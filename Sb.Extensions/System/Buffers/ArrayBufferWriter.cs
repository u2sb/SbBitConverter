...
public sealed class ArrayBufferWriter<T> : IBufferWriter<T>
{
  ...
  ///   </para>
  ///   <para>
  ///     You must request a new buffer after calling Advance to continue writing more data and cannot write to a
  ///     previously acquired buffer.
  ///   </para>
  ///   <para>
  ///     If you reset the writer using the <see cref="ResetWrittenCount" /> method, this method may return a non-cleared
  ///     <see cref="Memory{T}" />.
  ///   </para>
  ///   <para>
  ///     If you clear the writer using the <see cref="Clear" /> method, this method will return a
  ///     <see cref="Memory{T}" /> with its content zeroed.
  ///   </para>
  /// </remarks>
  ...
  ///   </para>
  ///   <para>
  ///     If you clear the writer using the <see cref="Clear" /> method, this method will return a <see cref="Span{T}" />
  ///     with its content zeroed.
  ///   </para>
  /// </remarks>
  ...
  ///   </para>
  ///   <para>
  ///     If you reset the writer using the <see cref="ResetWrittenCount" /> method, the underlying buffer will not be
  ///     cleared.
  ///   </para>
  /// </remarks>
  /// <seealso cref="Clear" />
